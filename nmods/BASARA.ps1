...
Write-Host -f GREEN '   
    ...
    Write-Host -f GREEN ' (a txt file that could be used to
    generate lists, JSON files, or whatever else you can think
    of).
    '
    ...
    Write-Host -f GREEN " variable
    gets set correctly in your environment -- this is the path to your
    user's desktop where " -NoNewline;
    Write-Host '$RESULTFILE' -NoNewline;
    Write-Host -f GREEN ' will typically write to. See the '
    ...
    $HOWMANY - successful results from the previous task; you can increment this
        across scripts
    $RESULTFILE - the text file generated by any given script that can be passed
        to other scripts
